...
| Enrichment extraction | Floor | `gpt-5-mini` | `ENRICHMENT_MODEL`  | `src/prompts/enrichment.v1.ts`   | `src/enrichment/enrichSession.ts`     |
| Handoff context       | Floor | `gpt-5-mini` | `HANDOFF_MODEL`     | `src/prompts/handoff.v1.ts`      | `src/enrichment/regenerateHandoff.ts` |
